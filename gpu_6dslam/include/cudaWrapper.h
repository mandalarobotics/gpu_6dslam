...
public:
	...
	static void Matrix4ToEuler(const double *alignxf, double *rPosTheta, double *rPos);
	static void Matrix4ToEuler(Eigen::Affine3f m, Eigen::Vector3f &omfika, Eigen::Vector3f &xyz);
	static void EulerToMatrix(Eigen::Vector3f omfika, Eigen::Vector3f xyz, Eigen::Affine3f &m);
